...
export const MacbookScroll = ({
  ...
  // const height = useTransform(scrollYProgress, [0, 1], [220, isMobile ? windowHeight : windowHeight]);
  // const width = useTransform(scrollYProgress, [0, 1], [520, isMobile ? windowWidth : windowWidth]);

  // console.log(height, width)

  const translate = useTransform(scrollYProgress, [0, 1], [0, 960]);
  ...
  return (
    <div
      ref={ref}
      className="min-h-[140vh] bg-sdt flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 
      [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <Lid
        src={src}
        scaleX={scaleX}
      ...
      />
      {/* Base area */}
      <div className="h-[22rem] w-[32rem] bg-sdt-200 dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
        ...
        {showGradient && (
          <div className="h-40 w-full absolute bottom-0 inset-x-0 bg-gradient-to-t dark:from-white from-sdtgrey via-sdtgrey dark:via-black to-transparent z-50"></div>
        )}
