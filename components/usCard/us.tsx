...
export function CanvasRevealEffectDemo() {
  return (
    <>
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center justify-center gap-4 bg-white px-0 py-10 dark:bg-neutral-950 lg:flex-row">
        <Card
        ...
        >
          ...
          <div className="absolute inset-0 bg-white [mask-image:radial-gradient(400px_at_center,white,transparent)] dark:bg-neutral-950" />
        </Card>
        <Card
        ...
        <Card
          title="Venezuelan-born, UK-based Marketing and Public Relations professional with years of experience fostering positive relationships between organizations and media. Committed to maintaining the reputation of institutions, strengthening consumer loyalty, and establishing credibility with clients."
          icon={
            <AceternityIcon
              name="Valery Villanueva"
