...
export function AboutUs() {
  return (
    <div
      id="aboutus"
      className="relative isolate w-full bg-white px-4 py-0 dark:bg-neutral-950 sm:py-10 lg:px-4"
    >
      <div className="0 relative mx-auto flex w-full max-w-7xl flex-col items-center justify-between md:flex-row">
        <div className="flex flex-col">
          ...
          <p className="mx-auto mt-8 max-w-md text-center text-sm text-neutral-600 dark:text-neutral-400 md:mx-0 md:text-left md:text-base">
            ...
            providing the best solutions for our clients. Our team is made up of
            experts in various fields, including web development, design, and
            marketing. We work together to create innovative and effective
            solutions that help our clients achieve their goals. Our mission is
            to help businesses grow and succeed in the digital world. We are
            committed to providing the highest quality services and support to
            our clients. Contact us today to learn more about how we can help
