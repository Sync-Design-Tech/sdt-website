          ...
          <div className="flex w-full flex-col">
            ...
            <section className="mb-12">
              ...
              <p className="mb-4 text-neutral-600 dark:text-neutral-400">
                Sync Design Tech Limited is a technology agency based in the
                United Kingdom. We specialize in app and website development,
                digital marketing, graphic design, and branding services.
              </p>
              <p className="mb-4 text-neutral-600 dark:text-neutral-400">
            ...
            <section className="mb-12">
              ...
              <p className="mb-4 text-neutral-600 dark:text-neutral-400">
                ...
                on your device. They help us understand how visitors use our
                site and enable certain site functionalities.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <ul className="mb-4 list-inside list-disc text-neutral-600 dark:text-neutral-400">
                <li>
                  <strong>Service Delivery:</strong> To provide and manage the
                  services you request.
                </li>
                <li>
                  <strong>Communication:</strong> To communicate with you
                  regarding inquiries, updates, and promotional materials.
                </li>
                <li>
                  <strong>Improvement:</strong> To analyze data to improve our
                  website, products, and services.
                </li>
                <li>
                  <strong>Security:</strong> To maintain the safety and security
            ...
            <section className="mb-12">
              ...
              <ul className="mb-4 list-inside list-disc text-neutral-600 dark:text-neutral-400">
                ...
                <li>
                  <strong>Legal Obligation:</strong> Compliance with a legal or
                  regulatory obligation.
                </li>
                <li>
                  <strong>Legitimate Interests:</strong> For our legitimate
                  business interests, provided your rights and interests do not
            ...
            <section className="mb-12">
              ...
              <ul className="mb-4 list-inside list-disc text-neutral-600 dark:text-neutral-400">
                <li>
                  ...
                  assist in operating our website and providing our services.
                </li>
                <li>
              ...
              <p className="mb-4 text-neutral-600 dark:text-neutral-400">
                ...
                are obligated to keep your information secure and to use it only
            ...
            <section className="mb-12">
              ...
              <p className="mb-4 text-neutral-600 dark:text-neutral-400">
                ...
                located outside of your country where the data protection laws
                may differ. We take steps to ensure your data is treated
            ...
            <section className="mb-12">
              ...
              <ul className="mb-4 list-inside list-disc text-neutral-600 dark:text-neutral-400">
                ...
                <li>
                  ...
                  personal data to you or a third party.
                </li>
                <li>
                ...
                <li>
                  ...
                  any time where we are relying on consent to process your data.
                </li>
              </ul>
              <p className="mb-4 text-neutral-600 dark:text-neutral-400">
            ...
            <section className="mb-12">
              ...
              <ul className="mb-4 list-inside list-disc text-neutral-600 dark:text-neutral-400">
                ...
                <li>
                  ...
                  recognize and count visitors and see how they move around the
                  website.
                </li>
                <li>
                ...
                <li>
                  ...
                  website, pages visited, and links followed.
                </li>
              </ul>
            ...
            <p className="mt-8 text-center text-neutral-600 dark:text-neutral-400">
              <strong>
                Thank you for trusting Sync Design with your digital needs. Your
